...
$query = mysqli_query($connection, "UPDATE sekolah_pelengkap SET 
                                   npsn_fk = '$npsn_fk',
                                   sk_pendirian = '$sk_pendirian',
                                   tgl_sk_pendirian = " . ($tgl_sk_pendirian ? "'$tgl_sk_pendirian'" : "NULL") . ",
                                   status_kepemilikan = '$status_kepemilikan',
                                   sk_izin_operasional = '$sk_izin_operasional',
                                   tgl_sk_izin_operasional = " . ($tgl_sk_izin_operasional ? "'$tgl_sk_izin_operasional'" : "NULL") . ",
                                   kebutuhan_khusus_dilayani = '$kebutuhan_khusus_dilayani',
                                   nomor_rekening = '$nomor_rekening',
                                   nama_bank = '$nama_bank',
                                   cabang_kcp_unit = '$cabang_kcp_unit',
                                   rekening_atas_nama = '$rekening_atas_nama',
                                   mbs = '$mbs',
                                   luas_tanah_milik_m2 = " . ($luas_tanah_milik_m2 ? "'$luas_tanah_milik_m2'" : "NULL") . ",
                                   luas_tanah_bukan_milik_m2 = " . ($luas_tanah_bukan_milik_m2 ? "'$luas_tanah_bukan_milik_m2'" : "NULL") . ",
...
if ($query) {
  $_SESSION['info'] = [
    'status' => 'success',
    'message' => 'Berhasil mengubah data pelengkap sekolah'
  ];
