...
if (empty($npsn)) {
    $_SESSION['info'] = [
        'status' => 'failed',
        'message' => 'Parameter NPSN tidak ditemukan',
        'swal' => [
            'title' => 'Gagal!',
            'text' => 'Parameter NPSN tidak ditemukan',
            'icon' => 'error'
        ]
    ];
...
// Ambil data sekolah untuk ditampilkan di konfirmasi
 $query_sekolah = mysqli_query($connection, "SELECT * FROM sekolah_identitas WHERE npsn = '$npsn'");
...
$_SESSION['info'] = [
    'status' => 'success',
    'message' => 'Data sekolah ' . $data_sekolah['nama_sekolah'] . ' berhasil dihapus.'
];
