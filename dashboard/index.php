          ...
          <div class="hero-text">
            ...
            <div class="hero-actions">
              <a href="analytics.php" class="btn btn-primary btn-lg hero-btn">
                <i class="fas fa-chart-line"></i> Buka Analisis Data
              </a>
      ...
      <div class="card modern-card">
        ...
        <div class="card-body">
          <div class="quick-actions-container">
            ...
            <!-- Action Baru: Laporan dengan Dropdown -->
            <div class="quick-action-item dropdown-container" data-dropdown="laporan">
              <div class="quick-action-link" id="laporanDropdown">
            ...
            <!-- Action Baru: Manajemen Pengguna dengan Dropdown -->
            <div class="quick-action-item dropdown-container" data-dropdown="user">
              <div class="quick-action-link" id="userDropdown">
                <div class="quick-action-icon manage-user">
...
<div id="laporanMenu" class="dropdown-menu-custom">
  <a href="../laporan/index.php" class="dropdown-item-custom">
    <i class="fas fa-school"></i>
    <span>Laporan Sekolah</span>
  </a>

  <a href="../laporan/laporan_ptk.php" class="dropdown-item-custom">
    <i class="fas fa-chalkboard-teacher"></i>
    <span>Laporan PTK</span>
  </a>

  <a href="../laporan/laporan_siswa.php" class="dropdown-item-custom">
    <i class="fas fa-user-graduate"></i>
    <span>Laporan Siswa</span>
  </a>

  <a href="../laporan/laporan_sarpras.php" class="dropdown-item-custom">
    <i class="fas fa-cubes"></i>
    <span>Laporan Sarana & Prasarana</span>
  </a>

  <a href="../laporan/laporan_rombel.php" class="dropdown-item-custom">
    <i class="fas fa-users"></i>
    <span>Laporan Rombongan Belajar</span>
  </a>

  <a href="../laporan/laporan_rasio.php" class="dropdown-item-custom">
    <i class="fas fa-balance-scale"></i>
    <span>Laporan Rasio PTK terhadap Peserta Didik</span>
  </a>
</div>
...
<div id="userMenu" class="dropdown-menu-custom">
  <a href="../user/index.php" class="dropdown-item-custom">
    <i class="fas fa-users"></i>
    <span>Daftar Pengguna</span>
  </a>
  <a href="../user/tambah.php" class="dropdown-item-custom">
    <i class="fas fa-user-plus"></i>
    <span>Tambah Pengguna</span>
  </a>
<!--   <a href="../user/hak_akses.php" class="dropdown-item-custom">
    <i class="fas fa-user-shield"></i>
    <span>Kelola Hak Akses</span>
  </a>
  <a href="../user/log_aktivitas.php" class="dropdown-item-custom">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupDropdowns() {
        ...
        // Setup Laporan dropdown
        const laporanTrigger = document.getElementById('laporanDropdown');
        const laporanMenu = document.getElementById('laporanMenu');
        
        if (laporanTrigger && laporanMenu) {
            console.log('Laporan dropdown elements found');
            laporanTrigger.addEventListener('click', function(e) {
                e.preventDefault();
                e.stopPropagation();
                console.log('Laporan dropdown clicked');
                
                const container = laporanTrigger.closest('.dropdown-container');
                toggleDropdown(container, laporanMenu, laporanTrigger);
            });
        } else {
            console.error('Laporan dropdown elements missing');
        }
        ...
        if (userTrigger && userMenu) {
            ...
            userTrigger.addEventListener('click', function(e) {
                ...
                const container = userTrigger.closest('.dropdown-container');
                toggleDropdown(container, userMenu, userTrigger);
            });
        } else {
