        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?= (basename($currentPath) == 'index.php' && strpos($currentPath, '/dashboard/') !== false) ? 'active' : '' ?>">
                <a class="nav-link" href="../dashboard/index.php">
                    <i class="fas fa-fire"></i><span>Halaman Utama</span>
                </a>
            </li>
            ...
            <li class="<?= (basename($currentPath) == 'analytics.php' && strpos($currentPath, '/dashboard/') !== false) ? 'active' : '' ?>">
                <a class="nav-link" href="../dashboard/analytics.php">
                    <i class="fas fa-chart-line"></i><span>Analisis Data</span>
                </a>
            </li>
            ...
            <li class="dropdown <?= isChildActive('/laporan/') ? 'active' : '' ?>">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="<?= (basename($currentPath) == 'laporan_ptk.php' && isChildActive('/laporan/')) ? 'active' : '' ?>">
                        <a class="nav-link" href="../laporan/laporan_ptk.php">
                            <span>Laporan PTK</span>
                        </a>
                    </li>

                    <li class="<?= (basename($currentPath) == 'laporan_siswa.php' && isChildActive('/laporan/')) ? 'active' : '' ?>">
                        <a class="nav-link" href="../laporan/laporan_siswa.php">
                            <span>Laporan Siswa</span>
                        </a>
                    </li>

    <li class="<?= (basename($currentPath) == 'laporan_sarpras.php' && isChildActive('/laporan/')) ? 'active' : '' ?>">
        <a class="nav-link" href="../laporan/laporan_sarpras.php">
            <span>Laporan Sarpras</span>
        </a>
    </li>

    <li class="<?= (basename($currentPath) == 'laporan_rombel.php' && isChildActive('/laporan/')) ? 'active' : '' ?>">
        <a class="nav-link" href="../laporan/laporan_rombel.php">
            <span>Laporan Rombel</span>
        </a>
    </li>

    <li class="<?= (basename($currentPath) == 'laporan_rasio.php' && isChildActive('/laporan/')) ? 'active' : '' ?>">
        <a class="nav-link" href="../laporan/laporan_rasio.php">
            <span>Laporan Rasio PTK</span>
        </a>
    </li>
            ...
            <li class="dropdown <?= isChildActive('/user/') ? 'active' : '' ?>">
                ...
                <ul class="dropdown-menu">
                    <li class="<?= (basename($currentPath) == 'index.php' && isChildActive('/user/')) ? 'active' : '' ?>">
                        <a class="nav-link" href="../user/index.php">Daftar Pengguna</a>
                    </li>
                    <li class="<?= (basename($currentPath) == 'tambah.php') ? 'active' : '' ?>">
                        <a class="nav-link" href="../user/tambah.php">Tambah Pengguna</a>
                    </li>
                </ul>
            </li>
