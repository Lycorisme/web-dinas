  ...
  if ($result->num_rows === 1) {
    ...
    if (password_verify($password, $user['password'])) {
      ...
      if (isset($_POST['remember']) && $_POST['remember'] == 'on') {
        // Set cookie untuk username dan password selama 30 hari
        $cookie_expiry = time() + (86400 * 30); // 30 hari
        setcookie('remember_username', $username, $cookie_expiry, "/");
        setcookie('remember_password', $password, $cookie_expiry, "/"); // Simpan password asli untuk verifikasi
      } else {
...
// Cek apakah ada cookie yang tersimpan
 ...
 $remember_checked = !empty($remembered_username) && !empty($remembered_password) ? 'checked' : '';
?>
...
<head>
  ...
  .password-toggle .toggle-password {
    border: 2px solid #e1e5eb;
    border-left: none;
    border-radius: 0 10px 10px 0; /* sudut kanan biar sama */
    padding: 0 12px;
    background: white;
    display: flex;
    align-items: center;
        ...
        <div class="card-body">
          ...
          <form method="POST" action="" class="needs-validation" novalidate="">
            <div class="form-group">
              <label for="username"><i class=""></i> Email</label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-user"></i></span>
                </div>
                <input id="username" type="text" class="form-control" name="username" tabindex="1" required autofocus 
                       value="<?php echo htmlspecialchars($remembered_username); ?>" placeholder="Masukkan username">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group password-toggle">
                ...
                <input id="password" type="password" class="form-control" name="password" tabindex="2" required 
                       value="<?php echo htmlspecialchars($remembered_password); ?>" placeholder="Masukkan password">
            ...
            <div class="login-options">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" name="remember" class="custom-control-input" id="remember-me-2" <?php echo $remember_checked; ?>>
