...
$result = mysqli_query($connection, "SELECT k.*, p.nama_provinsi 
                                    FROM kabupaten_kota k
                                    LEFT JOIN provinsi p ON k.id_provinsi_fk = p.id_provinsi
                                    ORDER BY p.nama_provinsi, k.nama_kabupaten");
?>
                            ...
                            <table class="table table-hover table-striped w-100" id="table-1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 100px;">ID Kabupaten</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td title="ID Kabupaten: <?= $data['id_kabupaten'] ?>">
                                                <span class="badge badge-primary"><?= htmlspecialchars($data['id_kabupaten']) ?></span>
                                            </td>
                                            <td title="<?= htmlspecialchars($data['nama_kabupaten']) ?>" class="school-name">
                                                <strong><?= htmlspecialchars($data['nama_kabupaten']) ?></strong>
                                            </td>
...
$(document).ready(function() {
    ...
    $('#table-1_filter input').attr('placeholder', 'Cari berdasarkan nama kabupaten atau provinsi...');
    ...
    $('#table-1').DataTable({
        ...
        order: [[2, 'asc']], // Default sort by nama kabupaten
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'Data Kabupaten/Kota - ' + new Date().toLocaleDateString('id-ID')
            },
            {
                extend: 'pdf',
        ...
        initComplete: function() {
            ...
            setTimeout(() => {
                ...
                $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari data kabupaten/kota...');
