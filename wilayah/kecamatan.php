...
$result = mysqli_query($connection, "SELECT k.*, kab.nama_kabupaten, p.nama_provinsi 
                                    FROM kecamatan k
...
$(document).ready(function() {
    ...
    $('#table-1_filter input').attr('placeholder', 'Cari berdasarkan nama kecamatan, kabupaten, atau provinsi...');
    ...
    $('#table-1').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'Data Kecamatan - ' + new Date().toLocaleDateString('id-ID')
            },
            {
                extend: 'pdf',
        ...
        initComplete: function() {
            ...
            setTimeout(() => {
                ...
                $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari data kecamatan...');
