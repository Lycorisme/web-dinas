...
$result = mysqli_query($connection, "SELECT * FROM negara ORDER BY nama_negara");
?>
...
$(document).ready(function() {
    ...
    $('#table-1_filter input').attr('placeholder', 'Cari berdasarkan nama negara...');
    ...
    $('#table-1').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'Data Negara - ' + new Date().toLocaleDateString('id-ID')
            },
            {
                extend: 'pdf',
        ...
        initComplete: function() {
            ...
            setTimeout(() => {
                ...
                $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari data negara...');
