<?php
// FILE: rekap/sarpras.php - Sarpras Recap Page
ob_start();
require_once '../layout/_top.php';
require_once '../helper/connection.php';

// Query untuk mendapatkan data total Sarpras per sekolah (tanpa duplikasi)
 $result = mysqli_query($connection, "SELECT 
                                    r.npsn_fk, 
                                    s.nama_sekolah, 
                                    s.jenjang_pendidikan,
                                    COUNT(r.id) as total_jenis,
...
<section class="section">
    <div class="section-header d-flex justify-content-between align-items-center">
        <h1>Rekapitulasi Sarana Prasarana</h1>
    </div>
    <div class="d-flex justify-content-end mb-3">
        <a href="./sarpras_create.php" class="btn btn-primary">
                            ...
                            <table class="table table-hover table-striped w-100" id="table-1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 100px;">Jenis Sarana</th>
                                        <th style="min-width: 80px;">Total Jumlah</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td title="Jenis Sarana: <?= $data['total_jenis'] ?>">
                                                <span class="badge badge-warning badge-pill px-3 py-2">
                                                    <i class="fas fa-cubes mr-1"></i>
                                                    <?= $data['total_jenis'] ?>
                                                </span>
                                            </td>
                                            <td title="Total Jumlah: <?= $data['total_jumlah'] ?>">
...
function confirmDeleteByNPSN(npsn, namaSekolah) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = `sarpras_hapus.php?npsn=${npsn}`;
        }
    })
}

// Fungsi untuk konfirmasi hapus individual
function confirmDelete(id, namaSekolah, sarana) {
    Swal.fire({
        title: 'Apakah Anda yakin?',
        text: "Anda akan menghapus data " + sarana + " untuk " + namaSekolah + "!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
 ...
 $(document).ready(function() {
    ...
    $('#table-1').DataTable({
        ...
        columnDefs: [
            { 
                orderable: false, 
                targets: [0, 6] // Kolom no dan aksi tidak bisa di-sort
            },
            {
                className: "text-center",
                targets: [0, 6] // Kolom no dan aksi di tengah
            }
        ],
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'Data Sarpras - ' + new Date().toLocaleDateString('id-ID')
            },
            {
                extend: 'pdf',
        ...
        initComplete: function() {
            ...
            setTimeout(() => {
                ...
                $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari data Sarpras...');
