...
// Query untuk mendapatkan data Sarpras dari tabel rekap_sarpras
$result = mysqli_query($connection, "SELECT r.*, s.nama_sekolah, s.jenjang_pendidikan
                                    ...
                                    ORDER BY s.nama_sekolah, r.sarana");
?>
                            ...
                            <table class="table table-hover table-striped w-100" id="table-1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 150px;">Sarana</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td title="Sarana: <?= htmlspecialchars($data['sarana']) ?>">
                                                <div class="d-flex align-items-center">
                                                    <i class="fas fa-cube text-warning mr-2"></i>
                                                    <span><?= htmlspecialchars($data['sarana']) ?></span>
                                                </div>
                                            </td>
                                            <td title="Jumlah: <?= $data['jumlah'] ?>">
...
$(document).ready(function() {
    ...
    $('#table-1_filter input').attr('placeholder', 'Cari berdasarkan nama sekolah, jenjang, atau sarana...');
