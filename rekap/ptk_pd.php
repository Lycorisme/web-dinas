<?php
// FILE: rekap/ptk_pd.php - PTK PD Recap Page
ob_start();
require_once '../layout/_top.php';
require_once '../helper/connection.php';

// Query untuk mendapatkan data total PTK PD per sekolah (tanpa duplikasi)
 $result = mysqli_query($connection, "SELECT 
                                    ...
                                    SUM(r.ptk_total) AS total_ptk,
                                    SUM(r.pd_total) AS total_pd
                                FROM rekap_ptk_pd r
                                LEFT JOIN sekolah_identitas s ON r.npsn_fk = s.npsn
                                GROUP BY r.npsn_fk, s.nama_sekolah, s.jenjang_pendidikan, s.status_sekolah
                                ORDER BY s.nama_sekolah");
?>

<section class="section">
    <div class="section-header d-flex justify-content-between align-items-center">
        <h1>Rekapitulasi PTK & Peserta Didik</h1>
    </div>
    <div class="d-flex justify-content-end mb-3">
        <a href="./ptk_pd_create.php" class="btn btn-primary">
                            ...
                            <table class="table table-hover table-striped w-100" id="table-1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 100px;">Guru</th>
                                        <th style="min-width: 100px;">Tendik</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td title="Jumlah Guru: <?= $data['total_guru'] ?>">
                                                <span class="badge badge-primary badge-pill px-3 py-2">
                                                    <i class="fas fa-chalkboard-teacher mr-1"></i>
                                                    <?= $data['total_guru'] ?>
                                                </span>
                                            </td>
                                            <td title="Jumlah Tendik: <?= $data['total_tendik'] ?>">
                                            ...
                                            <td title="Total Peserta Didik: <?= $data['total_pd'] ?>">
...
function confirmDeleteByNPSN(npsn, namaSekolah) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = `ptk_pd_hapus.php?npsn=${npsn}`;
        }
    })
}

// Fungsi untuk konfirmasi hapus individual
function confirmDelete(id, namaSekolah, deskripsi) {
    Swal.fire({
        title: 'Apakah Anda yakin?',
        text: "Anda akan menghapus data " + deskripsi + " untuk " + namaSekolah + "!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
 ...
 $(document).ready(function() {
    ...
    $('#table-1').DataTable({
        ...
        columnDefs: [
            { 
                orderable: false, 
                targets: [0, 8] // Kolom no dan aksi tidak bisa di-sort
            },
            {
                className: "text-center",
                targets: [0, 8] // Kolom no dan aksi di tengah
            }
        ],
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'Data PTK PD - ' + new Date().toLocaleDateString('id-ID')
            },
            {
                extend: 'pdf',
        ...
        initComplete: function() {
            ...
            setTimeout(() => {
                ...
                $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari data PTK PD...');
