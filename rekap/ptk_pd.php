...
// Query untuk mendapatkan data PTK PD dari tabel rekap_ptk_pd
$result = mysqli_query($connection, "SELECT r.*, s.nama_sekolah, s.jenjang_pendidikan, s.status_sekolah
                                    FROM rekap_ptk_pd r
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td title="Deskripsi: <?= htmlspecialchars($data['deskripsi']) ?>">
                                                <div class="d-flex align-items-center">
                                                    <i class="fas fa-info-circle text-info mr-2"></i>
                                                    <span><?= htmlspecialchars($data['deskripsi']) ?></span>
                                                </div>
                                            </td>
                                            <td title="Jumlah Guru: <?= $data['guru'] ?>">
                                                <span class="badge badge-primary badge-pill px-3 py-2">
                                                    <i class="fas fa-chalkboard-teacher mr-1"></i>
                                                    <?= $data['guru'] ?>
                                                </span>
                                            </td>
                                            <td title="Jumlah Tendik: <?= $data['tendik'] ?>">
                                                <span class="badge badge-warning badge-pill px-3 py-2">
                                                    <i class="fas fa-user-tie mr-1"></i>
                                                    <?= $data['tendik'] ?>
                                                </span>
                                            </td>
                                            <td title="Total PTK: <?= $data['ptk_total'] ?>">
                                                <span class="badge badge-success badge-pill px-3 py-2">
                                                    <i class="fas fa-users-cog mr-1"></i>
                                                    <?= $data['ptk_total'] ?>
                                                </span>
                                            </td>
                                            <td title="Total Peserta Didik: <?= $data['pd_total'] ?>">
...
$(document).ready(function() {
    ...
    $('#table-1_filter input').attr('placeholder', 'Cari berdasarkan nama sekolah, jenjang, atau deskripsi...');
