                                                ...
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <?php if ($user['id'] != 1) { ?>
                                                        <a class="btn btn-danger" href="javascript:void(0);"
                                                           onclick="confirmDelete('<?= $user['id'] ?>', '<?= htmlspecialchars($user['nama_pengguna']) ?>')"
...
function confirmDelete(id, name) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Redirect ke hapus.php dengan parameter id
...
<?php
// Notifikasi iziToast untuk operasi tambah, edit, hapus
