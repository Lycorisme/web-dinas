<?php
// FILE: laporan/laporan_rasio.php - Rasio PTK terhadap Peserta Didik Report Page
ob_start();
...
// Query data rasio jika ada filter
 $rasio_data = [];
 $show_data = false;
...
if (isset($_GET['kecamatan']) || isset($_GET['jenjang'])) {
    ...
    $rasio_result = mysqli_query($connection, $rasio_query);
    
    if (!$rasio_result) {
        echo "<!-- Database Error: " . mysqli_error($connection) . " -->";
    } else {
        while ($row = mysqli_fetch_assoc($rasio_result)) {
            $rasio_data[] = $row;
        }
    }
}
...
<section class="section">
    <div class="section-header d-flex justify-content-between align-items-center">
        <h1>Laporan & Ekspor Data Rasio PTK terhadap Peserta Didik</h1>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="get" action="">
                        ...
                        <?php if (!empty($rasio_data)): ?>
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="btn-group" role="group">
                                    <a href="export_pdf_rasio.php?<?php echo http_build_query($_GET); ?>" target="_blank" class="btn btn-danger">
                                        <i class="fas fa-file-pdf"></i> Export PDF
                                    </a>
                                    <button type="submit" formaction="export_excel_rasio.php" class="btn btn-success">
    ...
    <?php if ($show_data && empty($rasio_data)): ?>
    <!-- Pesan jika tidak ada data -->
    <div class="row">
        <div class="col-12">
            <div class="alert alert-warning">
                <i class="fas fa-exclamation-triangle"></i> Tidak ada data rasio PTK terhadap peserta didik yang sesuai dengan filter yang dipilih.
            </div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-table"></i> Data Rasio PTK terhadap Peserta Didik</h4>
                    <div class="card-header-action">
                        <span class="badge badge-primary">
                            <i class="fas fa-database"></i> 
                            <?php echo count($rasio_data); ?> Sekolah
                        </span>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <table class="table table-hover table-striped w-100" id="table-1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 100px;">Total Siswa</th>
                                        <th style="min-width: 100px;">Rasio Siswa/PTK</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($rasio_data as $data):
                                    ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            ...
                                            <td title="Total Siswa: <?= $data['total_siswa'] ?>">
                                                <span class="badge badge-success">
                                                    <i class="fas fa-child mr-1"></i>
                                                    <?= $data['total_siswa'] ?>
                                                </span>
                                            </td>
                                            <td title="Rasio Siswa/PTK: <?= $data['rasio_siswa_ptk'] ?>">
                                                <span class="badge badge-warning">
                                                    <i class="fas fa-balance-scale mr-1"></i>
                                                    <?= $data['rasio_siswa_ptk'] ?>
                                                </span>
                                            </td>
                                        </tr>
                                    <?php
        ...
        $('#table-1').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    title: 'Data Rasio PTK terhadap Peserta Didik - ' + new Date().toLocaleDateString('id-ID')
                },
                {
                    extend: 'pdf',
            ...
            initComplete: function() {
                ...
                setTimeout(() => {
                    ...
                    $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari data rasio PTK terhadap peserta didik...');
