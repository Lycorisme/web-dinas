<?php
// FILE: laporan/laporan_ptk.php - PTK Report Page
ob_start();
...
// Query data PTK jika ada filter
 $ptk_data = [];
 $show_data = false;
...
<section class="section">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="btn-group" role="group">
                                    <a href="export_pdf_ptk.php?<?php echo http_build_query($_GET); ?>" target="_blank" class="btn btn-danger">
                                        <i class="fas fa-file-pdf"></i> Export PDF
                                    </a>
                                    <button type="submit" formaction="export_excel_ptk.php" class="btn btn-success">
    ...
    <?php if ($show_data && empty($ptk_data)): ?>
    <!-- Pesan jika tidak ada data -->
    <div class="row">
        <div class="col-12">
            <div class="alert alert-warning">
                <i class="fas fa-exclamation-triangle"></i> Tidak ada data PTK yang sesuai dengan filter yang dipilih.
            </div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-table"></i> Data PTK</h4>
                    <div class="card-header-action">
                        <span class="badge badge-primary">
                            <i class="fas fa-database"></i> 
                            <?php echo count($ptk_data); ?> Sekolah
                        </span>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <table class="table table-hover table-striped w-100" id="table-1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="min-width: 100px;">Total Guru</th>
                                        <th style="min-width: 100px;">Total Tendik</th>
                                        <th style="min-width: 100px;">Total PTK</th>
                                        <th style="min-width: 100px;">PTK Laki-laki</th>
                                        <th style="min-width: 100px;">PTK Perempuan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($ptk_data as $data):
                                    ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            ...
                                            <td title="Total Guru: <?= $data['total_guru'] ?>">
                                                <span class="badge badge-primary">
                                                    <i class="fas fa-chalkboard-teacher mr-1"></i>
                                                    <?= $data['total_guru'] ?>
                                                </span>
                                            </td>
                                            <td title="Total Tendik: <?= $data['total_tendik'] ?>">
                                                <span class="badge badge-info">
                                                    <i class="fas fa-user-tie mr-1"></i>
                                                    <?= $data['total_tendik'] ?>
                                                </span>
                                            </td>
                                            <td title="Total PTK: <?= $data['total_ptk_guru_tendik'] ?>">
                                                <span class="badge badge-success">
                                                    <i class="fas fa-users-cog mr-1"></i>
                                                    <?= $data['total_ptk_guru_tendik'] ?>
                                                </span>
                                            </td>
                                            <td title="PTK Laki-laki: <?= $data['ptk_laki'] ?>">
                                                <span class="badge badge-warning">
                                                    <i class="fas fa-male mr-1"></i>
                                                    <?= $data['ptk_laki'] ?>
                                                </span>
                                            </td>
                                            <td title="PTK Perempuan: <?= $data['ptk_perempuan'] ?>">
        ...
        $('#table-1').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    title: 'Data PTK - ' + new Date().toLocaleDateString('id-ID')
                },
                {
                    extend: 'pdf',
            ...
            initComplete: function() {
                ...
                setTimeout(() => {
                    ...
                    $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari data PTK...');
