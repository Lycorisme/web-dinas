<?php
// Ambil data dari database (sudah dilakukan di export_pdf_siswa.php)
// Variabel yang tersedia: $data_siswa, $nama_kecamatan, $nama_jenjang
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
    ...
    <!-- Isi Laporan -->
    <div class="content">
        <div class="judul">Rekapitulasi Data Siswa (Peserta Didik)</div>
        
        <div class="info">
            <p><strong><?php echo htmlspecialchars($nama_kecamatan); ?></strong> <?php echo date('d F Y'); ?></p>
            <p><strong>Jumlah Data:</strong> <?php echo count($data_siswa); ?> sekolah</p>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th width="10%">Total PD Laki-laki</th>
                    <th width="10%">Total PD Perempuan</th>
                    <th width="10%">Total Keseluruhan PD</th>
                </tr>
            </thead>
            <tbody>
                <?php if (empty($data_siswa)): ?>
                <tr>
                    <td colspan="10" class="text-center">Tidak ada data siswa yang sesuai dengan filter</td>
                </tr>
                <?php else: ?>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($siswa['nama_sekolah']); ?></td>
                    <td><?php echo htmlspecialchars($siswa['jenjang_pendidikan']); ?></td>
                    <td><?php echo htmlspecialchars($siswa['status_sekolah']); ?></td>
                    <td><?php echo htmlspecialchars($siswa['nama_kecamatan']); ?></td>
                    <td><?php echo htmlspecialchars($siswa['nama_kabupaten']); ?></td>
                    <td><?php echo $siswa['total_pd_laki']; ?></td>
                    <td><?php echo $siswa['total_pd_perempuan']; ?></td>
                    <td><?php echo $siswa['total_pd_total']; ?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
